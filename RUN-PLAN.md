...
| 10 | A | practice bank p47–66 | ~98 Q, free | doing | "Pharmacology TEST BANK" (p47–59) + dental students 2022/2023 (p60–66). No answers in either. **p47–59 is partly off-syllabus** — autonomics, opioids, epinephrine — none of which the 8 canonical decks cover; expect `not-in-source` |
| 11 | A | practice bank p67–115 | ~139 Q, free | doing | "Pharma020" section — numbered `Q1)` not `1.`, answers present on only some. **The most off-syllabus section of the bank** — adrenergics, morphine, anaesthesia, insulin, aspirin all appear. Extract it all regardless; Job C decides what routes |
| 12 | A | practice bank p116–134 | ~73 Q, free | doing | every question carries an `Ans:` line. Cleanly on-syllabus |
...
**Tab summary:** quizzes done (63 Q, see row 6) · practice p1–46 done (174 Q,
see row 2 — beat its own estimate by 53; rows 10–12's "~98/~139/~73" estimates
likely undercount the same way and should be treated as floors, not
ceilings). 368 vision pages across quizzes / midterm / finals · 357 canonical
